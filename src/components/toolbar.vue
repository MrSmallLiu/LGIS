            ...
            changeLayer: function (layerID) {
                ...
                switch (layerID) {
                    ...
                    case 'gg':
                        ...
                        this.viewer.imageryLayers.addImageryProvider(new window.Cesium.UrlTemplateImageryProvider({
                            url: url
                        }));
                        break;
                    case 'arcgis':
                        this.viewer.imageryLayers.addImageryProvider(new window.Cesium.ArcGisMapServerImageryProvider({
